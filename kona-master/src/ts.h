...
#ifndef WIN32
// __thread is a GCC/Clang extension for thread-local storage.
// Previously this was defined as empty, making all thread-local
// variables into globals (not thread-safe). Now we keep __thread
// on platforms that support it (Linux, macOS with GCC/Clang).
// #define __thread  // removed: was silently breaking thread safety
#endif
